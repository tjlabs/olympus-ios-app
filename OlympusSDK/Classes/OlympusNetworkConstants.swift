...
let USER_WARD_SERVER_VERSION = "2025-04-16"
...
let USER_ENTRANCE_SERVER_VERSION = "2024-11-14"
let USER_AFFINE_SERVER_VERSION = "2025-08-25"
...
let REC_ME_SERVER_VERSION = "2026-02-04"
...
public func setServerURL(region: String) {
    ...
    USER_WARD_URL = USER_URL + "/" + USER_WARD_SERVER_VERSION + "/level"
    ...
    USER_ENTRANCE_URL = USER_URL + "/" + USER_ENTRANCE_SERVER_VERSION + "/entrance"
    USER_RC_URL = USER_URL + "/" + USER_SERVER_VERSION + "/rc"
    USER_AFFINE_URL = USER_URL + "/" + USER_AFFINE_SERVER_VERSION + "/sectors/{pk}/wgs84-transform"
    ...
    REC_ME_URL = REC_URL + "/" + REC_ME_SERVER_VERSION + "/mobile-event"
